		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Resumo IDOCs",
									"targetURL": "#comfidelidademundialresumoidocs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfidelidademundialresumoidocs-display": {
								"semanticObject": "comfidelidademundialresumoidocs",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fidelidademundial.resumoidocs",
									"url": sap.ui.require.toUrl("com/fidelidademundial/resumoidocs")
								}
							}
						}
					}

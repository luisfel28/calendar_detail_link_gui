		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comfidelidademundialzrefxcustreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfidelidademundialzrefxcustreport-display": {
								"semanticObject": "comfidelidademundialzrefxcustreport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fidelidademundial.zrefxcustreport",
									"url": sap.ui.require.toUrl("com/fidelidademundial/zrefxcustreport")
								}
							}
						}
					}
